...
//        comp1511Enrolment.assignMark(65);
        ...
        comp1511Enrolment.assignMark("ass1", 15, 20);

        // Give the student a passing mark for milestone 1 of assignment 2
        comp1511Enrolment.assignMark("milestone1", 13, 20);

        // Give the student a passing mark for milestone 2 of assignment 2
        comp1511Enrolment.assignMark("milestone2", 16, 20);

        // Give the student an assignment 2 mark which is the average of
        // milestone 1 and 2
        comp1511Enrolment.addAverageMark("ass2", "milestone1", "milestone2");

        // Give the student a prac mark which is the sum of assignment 1
        // and 2
        comp1511Enrolment.addSumMark("prac", "ass1", "ass2");

        // Give the student a passing exam mark.
        comp1511Enrolment.assignMark("exam", 50, 60);

        // Check logging of updates to existing marks
        comp1511Enrolment.assignMark("ass1", 16, 20);
        comp1511Enrolment.assignMark("milestone2", 13, 20);
